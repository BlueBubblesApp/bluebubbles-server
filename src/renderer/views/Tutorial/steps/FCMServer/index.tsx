        ...
        return (
            <section className={classes.root}>
                ...
                <Typography variant="subtitle2" className={classes.subtitle}>
                    In order for the server to send notifications and server
                    updates to your Android device, you will need to setup a
                    Google Firebase Account. This way, if your server ever
                    restarts, we can tell your phone that the server is using a
                    new ngrok address. Using Google FCM can also reduce
                    background battery usage, as it will not require a websocket
                    connection at all times.
                </Typography>
                <br />
                <Typography variant="subtitle2" className={classes.subtitle}>
                    <strong>1.</strong> Sign up &amp; login to your Google
                    Account
                </Typography>
                <Typography variant="subtitle2" className={classes.subtitle}>
                ...
                <Typography variant="subtitle2" className={classes.subtitle}>
                    <strong>3.</strong> Create a new project called
                    "BlueBubblesApp"
                </Typography>
                <Typography variant="subtitle2" className={classes.subtitle}>
                    <strong>4.</strong> Head into your project settings, then
                    into the "Service Accounts" tab
                </Typography>
                <img src={ProjectSettingsImage} alt="" />
                <br />
                <img src={ServiceAccountImage} alt="" />
                <Typography variant="subtitle2" className={classes.subtitle}>
                    <strong>5.</strong> Download your private key bundle by
                    clicking the "Generate new private key" button
                </Typography>
                <Typography variant="subtitle2" className={classes.subtitle}>
