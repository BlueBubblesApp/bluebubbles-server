    ...
    render() {
        return (
            <div id="leftStatusBar">
                <Link to="/debug">
                    <svg id="debugIcon" viewBox="0 0 512 512">
                        <g>
                            <path
                                d="M376.493,310.998c-1.577-29.167-24.972-52.562-54.139-54.139v-21.72h-6.235v21.72
                ...
                <Link to="/devices">
                    <svg id="deviceIcon" viewBox="0 0 512 512">
                        <g>
                            <path
                                d="M206.759,332.99H39.225c-3.894,0-7.065-3.173-7.065-7.067V53.353c0-3.893,3.172-7.065,7.065-7.065
                            ...
                            />
                            <path
                                d="M341.739,441.645v-34.742h-70.662V184.999c0-4.681,3.8-8.489,8.479-8.489h159.887
                            ...
                            />
                            <path
                                d="M459.967,273.775h-77.996c-11.104,0-20.132,9.037-20.132,20.138v147.732
