...
class FixedPlugin extends React.Component<Props, State> {
            ...
            >
                <div id="fixedPluginClasses" className={this.props.fixedClasses}>
                    ...
                    {/* <ul className="dropdown-menu">
                        ...
                        <li
                            className={
                                this.state.bgImage === imagine1 ? "active" : ""
                            }>
                            <a
                        ...
                        <li
                            className={
                                this.state.bgImage === imagine2 ? "active" : ""
                            }>
                            <a
                                className="img-holder switch-trigger"
                                onClick={() => {
                        ...
                        <li
                            className={
                                this.state.bgImage === imagine3 ? "active" : ""
                            }>
                            <a
                                className="img-holder switch-trigger"
                                onClick={() => {
                        ...
                        <li
                            className={
                                this.state.bgImage === imagine4 ? "active" : ""
                            }>
                            <a
                                className="img-holder switch-trigger"
                                onClick={() => {
