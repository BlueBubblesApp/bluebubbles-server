...
// Routers
import { ThemeRouter } from "../v1/routers/themeRouter";
import { HandleRouter } from "../v1/routers/handleRouter";
import { MessageRouter } from "../v1/routers/messageRouter";
import { ChatRouter } from "../v1/routers/chatRouter";
import { AttachmentRouter } from "../v1/routers/attachmentRouter";
import { FcmRouter } from "../v1/routers/fcmRouter";
import { ServerRouter } from "../v1/routers/serverRouter";
import { GeneralRouter } from "../v1/routers/generalRouter";
import { UiRouter } from "../v1/routers/uiRouter";
import { SettingsRouter } from "../v1/routers/settingsRouter";
import { ContactRouter } from "../v1/routers/contactRouter";
import { MetricsMiddleware } from "../v1/middleware/metricsMiddleware";
import { LogMiddleware } from "../v1/middleware/logMiddleware";
import { ErrorMiddleware } from "../v1/middleware/errorMiddleware";
import { MacOsRouter } from "../v1/routers/macosRouter";
import { iCloudRouter } from "../v1/routers/icloudRouter";
import { FaceTimeRouter } from "../v1/routers/facetimeRouter";
import { PrivateApiMiddleware } from "../v1/middleware/privateApiMiddleware";
import { HttpDefinition, HttpMethod, HttpRoute, HttpRouteGroup, KoaMiddleware } from "../../types";
import { SettingsValidator } from "../v1/validators/settingsValidator";
import { MessageValidator } from "../v1/validators/messageValidator";
import { HandleValidator } from "../v1/validators/handleValidator";
import { FcmValidator } from "../v1/validators/fcmValidator";
import { AttachmentValidator } from "../v1/validators/attachmentValidator";
import { ChatValidator } from "../v1/validators/chatValidator";
import { AlertsValidator } from "../v1/validators/alertsValidator";
import { ScheduledMessageValidator } from "../v1/validators/scheduledMessageValidator";
import { ScheduledMessageRouter } from "../v1/routers/scheduledMessageRouter";
import { ThemeValidator } from "../v1/validators/themeValidator";
                ...
                routes: [
                    {
                        method: HttpMethod.POST,
                        path: "register",
                        controller: TokenRouter.register
                    },
                    {
                        method: HttpMethod.POST,
                        path: "delete",
