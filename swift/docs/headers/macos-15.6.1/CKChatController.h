...
- (bool)_shouldPresentDetailsViewFromCanvasViewController:(id)arg0 tappedView:(id)arg1;
...
- (void)didRequestCreateCalendarEvent:(id)arg0;
- (void)didRequestLocationPush:(bool)arg0;
- (void)didRequestOpenWebView:(id)arg0;
...
- (void)navbarCanvasViewController:(id)arg0 selectedChipAction:(id)arg1;
- (void)navbarCanvasViewController:(id)arg0 selectedSuggestedReply:(id)arg1;
...
- (void)updateEmphasis;
- (void)updateEntryViewHeightIncludingAppStrip:(bool)arg0 animated:(bool)arg1;
- (void)updateEntryViewHeightIncludingAppStrip:(bool)arg0 isContentChange:(bool)arg1 animated:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)updateEntryViewHeightIncludingAppStrip:(bool)arg0 isContentChange:(bool)arg1 animated:(bool)arg2;
