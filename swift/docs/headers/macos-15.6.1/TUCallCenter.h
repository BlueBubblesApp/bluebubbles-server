...
- (bool)_isCallingAvailableOnSecondaryDeviceWithRelayCallingAvailability:(int)arg0 isProviderAvailable:(bool)arg1 isRelayAllowed:(bool)arg2 isEmergency:(bool)arg3 supportsBasebandCalling:(bool)arg4 shouldUseRelay:(bool *)arg5 isTelephonyProvider:(bool)arg6;
...
- (id)_allCalls;
- (id)_dialWithRequest:(id)arg0 completion:(id /* block */)arg1;
