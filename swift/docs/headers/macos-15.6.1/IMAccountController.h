...
@property (readonly, nonatomic) bool hasRelayApprovedAccount;
...
- (id)accountsWithServiceCapability:(id)arg0;
- (id)activeAccounts;
- (id)activeAccountsForService:(id)arg0;
- (id)activeAccountsWithServiceCapability:(id)arg0;
...
- (id)connectedAccountsWithServiceCapability:(id)arg0;
