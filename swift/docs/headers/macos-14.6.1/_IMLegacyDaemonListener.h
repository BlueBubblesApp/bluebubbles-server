...
- (void)account:(id)arg0 defaults:(id)arg1 blockList:(id)arg2 allowList:(id)arg3 blockingMode:(unsigned int)arg4 blockIdleStatus:(bool)arg5 status:(id)arg6 capabilities:(unsigned long long)arg7 serviceLoginStatus:(unsigned int)arg8 loginStatusMessage:(id)arg9;
...
- (void)account:(id)arg0 status:(id)arg1 capabilities:(unsigned long long)arg2 serviceLoginStatus:(unsigned int)arg3 loginStatusMessage:(id)arg4;
