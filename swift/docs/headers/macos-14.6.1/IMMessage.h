...
+ (id)instantMessageWithAssociatedMessageContent:(id)arg0 flags:(unsigned long long)arg1 associatedMessageGUID:(id)arg2 associatedMessageType:(long long)arg3 associatedMessageRange:(_NSRange)arg4 messageSummaryInfo:(id)arg5 threadIdentifier:(id)arg6;
...
- (id)initWithSender:(id)arg0 time:(id)arg1 text:(id)arg2 messageSubject:(id)arg3 fileTransferGUIDs:(id)arg4 flags:(unsigned long long)arg5 error:(id)arg6 guid:(id)arg7 subject:(id)arg8 balloonBundleID:(id)arg9 payloadData:(id)arg10 expressiveSendStyleID:(id)arg11 threadIdentifier:(id)arg12 scheduled:(bool)arg13;
