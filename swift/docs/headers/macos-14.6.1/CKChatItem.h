...
- (double)_additionalBottomPaddingForChatItem:(id)arg0 datasourceItemIndex:(long long)arg1 allDatasourceItems:(id)arg2 prevChatItem:(id)arg3 layoutEnvironment:(id)arg4;
- (double)_additionalTopPaddingForChatItem:(id)arg0 datasourceItemIndex:(long long)arg1 allDatasourceItems:(id)arg2 prevChatItem:(id)arg3 layoutEnvironment:(id)arg4;
- (double)maxWidth;
- (id)IMChatItem;
- (id)cellIdentifier;
...
- (id)layoutItemSpacingForReplyItemWithEnvironment:(id)arg0 datasourceItemIndex:(long long)arg1 allDatasourceItems:(id)arg2 supplementryItems:(id)arg3;
- (id)layoutItemSpacingForReplyThreadOriginatorWithEnvironment:(id)arg0 datasourceItemIndex:(long long)arg1 allDatasourceItems:(id)arg2 supplementryItems:(id)arg3;
- (id)layoutItemSpacingWithEnvironment:(id)arg0 datasourceItemIndex:(long long)arg1 allDatasourceItems:(id)arg2 supplementryItems:(id)arg3;
