...
- (id)mediaObjectWithFileURL:(id)arg0 filename:(id)arg1 fileIsResolved:(bool)arg2 transcoderUserInfo:(id)arg3 attributionInfo:(id)arg4 hideAttachment:(bool)arg5 isScreenshot:(bool)arg6;
...
- (id)transferWithStickerFileURL:(id)arg0 transferUserInfo:(id)arg1 attributionInfo:(id)arg2 animatedImageCacheURL:(id)arg3;
