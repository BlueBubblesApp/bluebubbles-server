...
- (id)messageGUIDsWithFixupRequested;
- (id)orderedTransfers;
- (id)orderedTransfersGUIDs;
- (id)originalGUIDToTransferMap;
- (id)pendingTransfers;
...
- (void)_addTransferToOriginalGUIDMap:(id)arg0;
...
- (void)_handleFileTransfer:(id)arg0 rejectedWithProperties:(id)arg1;
...
- (void)_notifyDaemonForIncompleteTransferMigration:(id)arg0;
...
- (void)_unregisterTransfer:(id)arg0;
...
- (void)acceptTransfer:(id)arg0 withPath:(id)arg1 source:(long long)arg2 autoRename:(bool)arg3 overwrite:(bool)arg4;
...
- (void)registerNewFileTransfer:(id)arg0;
...
- (void)setMessageGUIDsWithFixupRequested:(id)arg0;
- (void)setOriginalGUIDToTransferMap:(id)arg0;
