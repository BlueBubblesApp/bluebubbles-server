...
- (id)initWithPseudonym:(id)arg0 publicKey:(id)arg1 groupUUID:(id)arg2 originatorHandle:(id)arg3 creationDate:(id)arg4 deletionDate:(id)arg5 expirationDate:(id)arg6 invitedMemberHandles:(id)arg7 locallyCreated:(bool)arg8 linkName:(id)arg9 linkLifetimeScope:(long long)arg10 deleteReason:(long long)arg11;
...
- (void)setDeleteReason:(long long)arg0;
