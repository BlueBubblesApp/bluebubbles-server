...
@property (nonatomic) bool nearbyContactDiscoveryEnabled;
...
- (bool)nearbyContactDiscoveryEnabled;
...
- (void)approveExternalParticipants:(id)arg0;
...
- (void)dealloc;
- (void)denyExternalParticipants:(id)arg0;
...
- (void)setNearbyContactDiscoveryEnabled:(bool)arg0;
