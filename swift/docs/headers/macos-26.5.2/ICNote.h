...
+ (id)contentInfoAttributedTextWithSnippet:(id)arg0 attachmentContentInfoType:(short)arg1 attachmentContentInfoCount:(long long)arg2 account:(id)arg3;
...
+ (id)predicateForVisibleNotesIncludingTrash:(bool)arg0 includingSystemPaper:(bool)arg1 includingMathNotes:(bool)arg2 includingCallNotes:(bool)arg3 inContext:(id)arg4;
...
+ (void)createNoteForAirDropDocument:(id)arg0 processAttributedString:(id /* block */)arg1 completion:(id /* block */)arg2;
...
- (_NSRange)rangeForSnippetWithTitleRange:(_NSRange)arg0;
...
- (bool)mergeEncryptedDataFromRecord:(id)arg0;
...
- (bool)textStorageHasAttribute:(id)arg0;
...
- (id)addAttachmentWithFileURL:(id)arg0 filename:(id)arg1 updateFileBasedAttributes:(bool)arg2 analytics:(bool)arg3;
- (id)addAttachmentWithFileURL:(id)arg0 filename:(id)arg1;
...
- (id)addAttachmentWithUTI:(id)arg0 data:(id)arg1 filename:(id)arg2 updateFileBasedAttributes:(bool)arg3 analytics:(bool)arg4 regulatoryLogging:(bool)arg5;
...
- (id)addAttachmentWithUTI:(id)arg0 identifier:(id)arg1 urlString:(id)arg2 analytics:(bool)arg3 regulatoryLogging:(bool)arg4;
- (id)addAttachmentWithUTI:(id)arg0 identifier:(id)arg1 urlString:(id)arg2 analytics:(bool)arg3;
- (id)addAttachmentWithUTI:(id)arg0 withURL:(id)arg1 filename:(id)arg2 updateFileBasedAttributes:(bool)arg3 analytics:(bool)arg4;
...
- (id)addAudioAttachmentWithIdentifier:(id)arg0;
...
- (id)csPersonForShareParticipant:(id)arg0;
- (id)dataSourceIdentifier;
- (id)decryptTextDataOrSaveAsUnappliedRecordIfNotAuthenticated:(id)arg0;
- (id)decryptedData;
- (id)descendantsNeedingOnDemandAssetFetchWithContext:(id)arg0 shouldFetchObject:(id /* block */)arg1;
...
- (id)timestamp;
- (id)titleForLinking;
- (id)titleForParagraphID:(id)arg0;
...
- (void)inlineAssetsForRecord:(id)arg0;
- (void)markActivitySummaryViewed;
- (void)markAsCallNoteIfAttachmentIsCallRecording;
- (void)markAsCallNoteIfNeeded:(bool)arg0;
- (void)markAsMathNoteIfNeeded:(bool)arg0;
...
- (void)setHostApplicationIdentifier:(id)arg0;
...
- (void)setOutlineState:(id)arg0;
- (void)setOutlineStateData:(id)arg0;
