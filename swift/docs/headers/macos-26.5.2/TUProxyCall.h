...
@property (nonatomic) bool callerIDBlocked;
...
- (void)addScreenSharingType:(unsigned long long)arg0;
...
- (void)setCallerIDBlocked:(bool)arg0;
...
- (void)setNearbyMode:(long long)arg0;
...
- (void)setScreenSharingIntention:(long long)arg0;
