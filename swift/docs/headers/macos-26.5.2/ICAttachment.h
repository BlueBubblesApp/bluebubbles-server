...
@property (readonly, nonatomic) bool hasUnfetchedFallbackImage;
@property (readonly, nonatomic) bool hasUnfetchedLinkPresentationMetadata;
...
@property (readonly, nonatomic) bool willShowFallbackImage;
...
+ (void)setSuppressWritingPaperKitBundles:(bool)arg0;
...
- (bool)hasOrientation;
- (bool)hasSynapseLink;
- (bool)hasUnfetchedAssetForRecordKey:(id)arg0;
- (bool)hasUnfetchedFallbackImage;
...
- (bool)updateHandwritingSummary:(id)arg0;
