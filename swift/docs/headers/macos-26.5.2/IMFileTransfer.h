...
@property (nonatomic) bool replacedWithBlastDoorVersionDuringFinalize;
@property (nonatomic) bool shouldAttemptToResume;
@property (nonatomic) bool shouldForceArchive;
@property (nonatomic) bool shouldNotTranscribeAudio;
...
+ (bool)isDownloadExpiredWithTransferUserInfo:(id)arg0 createdDate:(id)arg1;
...
+ (id)refreshDateWithUserInfo:(id)arg0 createdDate:(id)arg1;
+ (id)whitelistedKeys;
...
- (bool)replacedWithBlastDoorVersionDuringFinalize;
...
- (void)_setAcceptSource:(long long)arg0;
...
- (void)setReplacedWithBlastDoorVersionDuringFinalize:(bool)arg0;
- (void)setSandboxToken:(id)arg0;
- (void)setShouldAttemptToResume:(bool)arg0;
- (void)setShouldNotTranscribeAudio:(bool)arg0;
...
- (void)setTranscoderUserInfoObject:(id)arg0 forKey:(id)arg1;
