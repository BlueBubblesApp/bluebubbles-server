...
+ (id)contentInfoTextForAttachmentType:(short)arg0 withCount:(unsigned long long)arg1;
+ (void)deletePreviewItemHardLinkURLsWithContext:(id)arg0;
...
- (bool)usesChildAttachment:(id)arg0;
...
- (void)assetWithCompletion:(id /* block */)arg0;
