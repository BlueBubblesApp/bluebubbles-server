...
- (id)_changedKeysForNewNicknameDictionary:(id)arg0 oldNicknameDictionary:(id)arg1 withComparisonOptions:(unsigned long long)arg2;
...
- (id)unknownSenderRecordInfoFor:(id)arg0;
- (id)unknownSenderRecords;
...
- (void)setUnknownSenderRecords:(id)arg0;
