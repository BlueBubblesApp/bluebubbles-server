...
@property (nonatomic) bool isPrefixedWithMaybe;
...
- (id)immediateNameWithNeedsSuggestedNameFetch:(bool *)arg0 useSuggestedName:(bool)arg1 allowHandles:(bool)arg2;
...
- (void)_fetchBrandInfoForBrandWithURI:(id)arg0 forType:(unsigned long long)arg1 simID:(id)arg2;
- (void)_fetchBrandInfoForBusiness:(unsigned long long)arg0 simID:(id)arg1;
- (void)_fetchBrandLogoFromChatRegistryFor:(id)arg0;
- (void)_fetchChatBotBrandInfoWithSimID:(id)arg0;
- (void)_fetchedBrand:(id)arg0 withBrandURI:(id)arg1 simID:(id)arg2;
...
- (void)autoInviteToViewOffGridModeIfNeededFromHandleID:(id)arg0;
- (void)beginNotificationQueue;
- (void)customPictureDataChanged:(id)arg0 key:(id)arg1;
- (void)dealloc;
- (void)encodeWithCoder:(id)arg0;
- (void)fetchBrandInfoIfNecessary;
- (void)fetchBrandInfoIfNecessaryWithSimID:(id)arg0;
- (void)forceFetchChatBotBrandInfoWithSimID:(id)arg0;
...
- (void)setCachedNameThatIsNotHandle:(id)arg0;
...
- (void)setIsPrefixedWithMaybe:(bool)arg0;
