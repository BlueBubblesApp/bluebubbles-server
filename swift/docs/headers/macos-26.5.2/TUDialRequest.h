...
@property (nonatomic) bool sos;
@property (nonatomic) bool useAdditionalSpamMitigations;
@property (nonatomic) bool useAdditionalSpamMitigations;
...
- (bool)shouldBypassRTTPrompt;
- (bool)shouldSuppressInCallUI;
- (bool)showUIPrompt;
- (bool)useAdditionalSpamMitigations;
- (bool)useTTY;
...
- (id)initWithProvider:(id)arg0 featureFlags:(id)arg1;
- (id)initWithProvider:(id)arg0;
- (id)initWithService:(int)arg0 featureFlags:(id)arg1;
- (id)initWithService:(int)arg0;
- (id)initWithURL:(id)arg0 featureFlags:(id)arg1;
- (id)initWithURL:(id)arg0 translationRequestConfiguration:(id)arg1;
...
- (id)legacyAddressBookIdentifierQueryItemNameFromURLComponents:(id)arg0;
...
- (void)setOriginatingDeviceName:(id)arg0;
...
- (void)setUpgradedFromCallUUID:(id)arg0;
- (void)setUseAdditionalSpamMitigations:(bool)arg0;
