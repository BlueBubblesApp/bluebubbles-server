...
+ (id)mergedRemoteMemberHandlesFromRemoteMembers:(id)arg0 withLocalMemberAssociation:(id)arg1 removingLocallyAssociatedMember:(bool)arg2;
+ (id)mergedRemoteMembers:(id)arg0 withLocalMemberAssociation:(id)arg1 removingLocallyAssociatedMember:(bool)arg2;
+ (id)numberFormatter;
...
- (id)inCallDisplayNameUsingContactsDataSource:(id)arg0;
- (id)initWithCoder:(id)arg0;
- (id)initWithConversation:(id)arg0;
- (id)initWithUUID:(id)arg0 groupUUID:(id)arg1 provider:(id)arg2 screenSharingRequests:(id)arg3;
...
- (void)handleContactStoreDidChange:(id)arg0;
...
- (void)setCachedDisplayName:(id)arg0;
...
- (void)setLocalCaptionToken:(long long)arg0;
- (void)setLocalMember:(id)arg0;
- (void)setLocalParticipantAssociation:(id)arg0;
- (void)setLocalParticipantCluster:(id)arg0;
...
- (void)setNearbySession:(bool)arg0;
...
- (void)setScreenSharingRequests:(id)arg0;
