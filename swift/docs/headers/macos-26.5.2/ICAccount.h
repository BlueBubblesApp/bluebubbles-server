...
+ (id)newAccountWithIdentifier:(id)arg0 type:(int)arg1 context:(id)arg2 persistentStore:(id)arg3;
...
+ (void)setHidesCallNotesInCustomFolders:(bool)arg0;
+ (void)setHidesMathNotesInCustomFolders:(bool)arg0;
...
- (id)visibleNotes;
- (id)visibleRootFolderWithTitle:(id)arg0;
