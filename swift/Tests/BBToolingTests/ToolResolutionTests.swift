...
struct ToolParsingTests {
  ...
  func readsVersionOutput() {
    #expect(ToolVersionProbe.version(in: "ngrok version 3.18.4") == "3.18.4")
    #expect(
      ToolVersionProbe.version(in: "cloudflared version 2024.8.2 (built 2024-08-01)") == "2024.8.2")
    #expect(ToolVersionProbe.version(in: "zrok v1.0.4\n") == "1.0.4")
    #expect(ToolVersionProbe.version(in: "no version here") == nil)
  }
