...
public enum DiagnosticText {
  ...
  /// answer it, and two rules for one question would drift — which is exactly what happened:
  /// the app carried its own `userFacingMessage` with steps 1 and 3 spelled differently, and
  /// step 3 is the half worth keeping. There is one rule again.
