...
//  events as they arrive (`FindMyFriendsCache.ts`). `Items.data` is not a friends file
//  either; it holds AirTags and accessories, which the previous server folds into DEVICES.
//
