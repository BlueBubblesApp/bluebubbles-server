...
//
//  **This is no longer where the running server keeps its certificate.** The Keychain is —
...
//  nothing else. Do not add a caller that writes here at runtime; a second store is what made
//  a renewal update one copy while the reader consulted the other.
//
