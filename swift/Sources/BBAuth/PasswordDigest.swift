...
//
//  Reading the Keychain on EVERY authenticated request has two costs, one obvious and one
//  not:
//
...
//
//  Hashing once at first use avoids both, and is better for the plaintext too: it exists in
//  memory once, briefly, and never again for the life of the process.
//
