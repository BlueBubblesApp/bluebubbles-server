...
//  Those two properties are the whole point of the type: a migration that runs itself has no
...
public enum MigrationRunner {
  ...
  private static func perform(
    ...
    case .certificates:
      ...
      // Provenance, which `expiration.txt`'s presence encodes on an Electron install. Recorded
