        ...
        GlassCard {
          VStack(alignment: .leading, spacing: 6) {
            ...
            if let manifest = httpManifest, !model.integrations.isEnabled(manifest) {
              ...
              // PLACEHOLDER, which is what withholds the copy button. It was previously
              // shown as the value with the button disabled beside it, which reads as a
              // copy that is unavailable rather than as a value that is not there.
