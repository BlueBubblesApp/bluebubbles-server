...
//
//  See docs/api/README.md § Responses that are not the envelope.
...
public enum NonJSONResponses {
  ...
  public static let binary: [HandlerID: (contentType: String, description: String)] = [
    ...
    "chat.groupIcon": ("application/octet-stream", "The conversation's group photo, as bytes."),
    "chat.background": (
