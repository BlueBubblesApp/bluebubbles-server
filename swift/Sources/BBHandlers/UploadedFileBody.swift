...
//  `POST /message/attachment` is exactly that form. `ReplayDenyListTests` keeps the send
//  routes out of fixture replay, so the parity harness cannot check this shape: the OpenAPI
//  document declares it, and this is what honours it.
//
