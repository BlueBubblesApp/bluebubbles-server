...
//
//  The migration identifier is `createSettings`, without the module namespace, because that
//  string is a row in `grdb_migrations` on every install in the field. See
