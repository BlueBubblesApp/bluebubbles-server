...
//  is exactly right.
//
//  It is a decision about another application's process, reachable from the app's
//  maintenance screen as well as from `mac/imessage/restart`, so it is an interface rather
//  than a private function on the HTTP handler.
