...
final class Launcher {
  ...
  /// Running → stopped edge detection. `RunStateTracker` rather than a `Bool` here because
  /// the distinction it encodes — expectation, not last sample — is the one that was wrong.
