...
public enum SuccessMessages {
  ...
  static let byHandler: [HandlerID: String] = [
    ...
    .messageReschedule: "Scheduled message updated!",
    .messageSendScheduledNow: "Message sent!",
    .messageAppPayload: "Successfully fetched app message!",
    .messageSendApp: "App message sent!",
    .messageSendGamePigeon: "Game Pigeon message sent!",
    ...
    // Both from `chatRouter.ts:356` and `:366`. Neither had an entry, so both answered the
    // default "Success" where the reference sends its own sentence; the status route's was
    // caught by the corpus once a stub helper let it be replayed at all.
    .chatShouldShareContact: "Successfully got contact sharing status!",
    .chatShareContact: "Successfully shared contact info!",
