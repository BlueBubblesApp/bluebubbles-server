...
public enum ErrorRenderer {
  ...
  /// restated here — this comment used to describe them and fell out of date the moment the
  /// rule gained a fourth, which is the small version of exactly the drift the delegation
  /// exists to prevent.
  ///
