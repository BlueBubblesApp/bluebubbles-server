...
extension HandlerID {
  ...
  public static let stickerList = HandlerID("sticker.list")
  public static let stickerDetail = HandlerID("sticker.detail")
  public static let stickerImage = HandlerID("sticker.image")
  public static let stickerSave = HandlerID("sticker.save")
  ...
  public static let messageAppPayload = HandlerID("message.appPayload")
  public static let messageSendApp = HandlerID("message.sendApp")
  public static let messageSendGamePigeon = HandlerID("message.sendGamePigeon")
