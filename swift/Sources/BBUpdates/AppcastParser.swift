...
//  disagreeing: the reference polls GitHub while its updater reads something else, so
  ...
  private final class Delegate: NSObject, XMLParserDelegate {
    ...
    func parser(
      ...
      if insideItem {
        ...
        case "sparkle:fullReleaseNotesLink":
          item?.fullReleaseNotesLink = value.isEmpty ? nil : value
        case "sparkle:channel": item?.channel = value.isEmpty ? nil : value
