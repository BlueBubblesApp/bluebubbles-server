...
//  reactions need macOS 15") would otherwise be written in three places that can disagree:
//  a hardcoded `>= 15` in a gate, a sentence in `docs/MACOS_COMPATIBILITY.md`, and whatever
//  a screen says. Adding a feature would mean remembering all three, and nothing would fail
//  when somebody did not.
//
