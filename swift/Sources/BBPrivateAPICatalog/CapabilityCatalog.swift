...
extension PrivateAPICapability {
  ...
  public static let groupManagement = Self(
    ...
    category: .organising,
    messagesActions: [
      .createChat, .addParticipant, .removeParticipant, .setDisplayName, .updateGroupPhoto,
      .leaveChat, .deleteChat, .deleteMessage, .clearChatHistory,
    ])
  ...
  public static let faceTime = Self(
    ...
    category: .faceTime,
    faceTimeActions: [
      .admitPendingMember, .answerCall, .dialFaceTime, .faceTimeActiveCalls, .faceTimeCallStatus,
      .faceTimeDismissAlert, .faceTimeMembers, .generateLink, .invalidateFaceTimeLinks, .leaveCall,
      .silenceFaceTimeCall,
    ])
  ...
  public static let findMy = Self(
    ...
    category: .findMy,
    messagesActions: [
      .findMyFriends, .findMyStatus, .refreshFindMyFriends, .refreshFindMyLocation,
      .requestFindMyLocationShare, .startSharingFindMyLocation, .stopSharingFindMyLocation,
    ])
  ...
  public static let sendLater = Self(
    ...
    category: .messages,
    messagesActions: [
      .cancelScheduledMessage, .editScheduledMessage, .rescheduleMessage, .sendScheduledNow,
    ])
  ...
  public static let all: [PrivateAPICapability] = [
    ...
    richSending, messageEffects, replies, mentions, editMessage, unsendMessage, typingIndicators,
    readState,
...
extension Array where Element == PrivateAPICapability {
  ...
  public func upgradePaths(from macOSMajor: Int) -> [(
    macOS: Int, capabilities: [PrivateAPICapability]
  )] {
