...
//
//  Two rules, and both were bugs first.
//
//    - **A COUNT, not a flag.** "Is it connected?" cannot answer "did the injection I just
//      performed work?". Re-injecting an app that was already connected short-circuited on
//      the existing registration and reported success — measured: `mac/imessage/restart`
//      returned 200 with Messages' pid unchanged, having done nothing. A caller snapshots
//      the count first and waits for one NEWER than that.
