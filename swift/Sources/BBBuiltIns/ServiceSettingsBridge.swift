...
public enum ServiceSettingsBridge {
  ...
  private static func services(in problem: ManifestProblem) -> [ServiceIdentifier] {
    ...
    case .unknownDependency(let service, _),
      .duplicatePermission(let service, _),
      .permissionWithoutPurpose(let service, _),
      ...
      .incoherentVersionRange(let service, _),
      .recommendedVersionOutsideCompatibleRange(let service, _):
      [service]
