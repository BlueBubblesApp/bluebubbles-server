...
public enum BuiltInManifests {
  ...
  public static var lan: ServiceManifest {
    ServiceManifest(
      ...
      entitlements: [
        .readSettings(keys: ["connection_method", "socket_port"]),
        .writeSettings(keys: ["server_address"]),
      ],
      settings: [
        .paragraph(
  ...
  public static let push = ServiceManifest(
    ...
    entitlements: [
      ...
      .readSettings(keys: [
        "server_address", "remote_restart_enabled", "last_fcm_restart",
      ]),
      .writeSettings(keys: ["last_fcm_restart"]),
    ]
  )
  ...
  public static let http = ServiceManifest(
    ...
    entitlements: [
      ...
      .readSettings(keys: [
        "socket_port", "bind_address", "use_custom_certificate", "server_address",
        ...
        "tls_certificate_origin", "tls_certificate_expires_at",
      ]),
      ...
      .writeSettings(keys: ["tls_certificate_origin", "tls_certificate_expires_at"]),
    ]
  )
