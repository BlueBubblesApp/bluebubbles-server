# BlueBubbles Entity Contributor License Agreement

Thank you for your interest in contributing to the BlueBubbles Swift server,
maintained by Zachary Shames ("We" or "Us").

**Use this document if contributions are being made on behalf of an
organization** — because an employee is contributing as part of their job, or
because the organization otherwise owns the copyright in the work. Individuals
contributing their own personally-owned work should sign [`CLA.md`](CLA.md)
instead.
...
Fill in the signature block at the end, have it signed by someone authorized to
bind the organization, and email a scanned or digitally signed copy to
**bluebubblesapp@gmail.com**. Include a list of the GitHub accounts authorized to
contribute on the organization's behalf, and email us to update that list as
people join or leave.

We will confirm receipt. Contributions from the listed accounts are then covered,
and those individuals do not separately need to sign the individual agreement.
...
by Us. "Legal Entity" means an entity which is not a natural person. "Affiliates"
means other Legal Entities that control, are controlled by, or under common
control with that Legal Entity. For the purposes of this definition, "control"
...
percent (50%) or more of the outstanding shares or securities which vote to elect
the management or other persons who direct such Legal Entity or (iii) beneficial
ownership of such entity.

"Contribution" means any work of authorship that is Submitted by You to Us in
which You own or assert ownership of the Copyright. If You do not own the
Copyright in the entire work of authorship, please identify the portions You did
not author, and their licenses, when Submitting.
...
use, sell, offer for sale, import and otherwise transfer the Contribution and the
Contribution in combination with the Material (and portions of such combination).
This license is granted only to the extent that the exercise of the licensed
rights infringes such patent claims; and provided that this license is
...
(d) You have identified any portions of the Submitted work of authorship in which
You do not own the Copyright, together with their licenses.
...
```
Name:         Zachary Shames (BlueBubbles)
...
GitHub accounts authorized to Submit Contributions on Your behalf. Email
bluebubblesapp@gmail.com to add or remove accounts.
