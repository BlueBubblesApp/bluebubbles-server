# BlueBubbles Individual Contributor License Agreement

Thank you for your interest in contributing to the BlueBubbles Swift server,
maintained by Zachary Shames ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please follow the
instructions under **How to sign** below. This is a legally binding document, so
please read it carefully before agreeing to it. The Agreement may cover more than
one software project managed by Us.

## What this covers, in plain English

This summary is not part of the Agreement and has no legal effect. Read the
Agreement itself.

- **You keep the copyright in your work.** This is a license, not an assignment.
  Section 2.1(a) preserves every right you would have had without signing.
- **You grant us the right to license your contribution to others**, including
  under commercial and proprietary terms. This is what lets us sell commercial
  licenses to companies over the size threshold in `COMMERCIAL.md`. Without it,
  we could not lawfully include your code in those agreements.
- **In exchange, we are bound to keep your contribution available under the
  project's public license.** Section 2.3 makes this a condition, not a promise:
  if we license your work commercially, we must *also* continue licensing it
  under the license the project used on the day you submitted. We cannot take
  your contribution proprietary-only.
- **You are confirming you actually have the right to give us the code**, per
  section 3. If your employer owns your work, they need to sign the entity
  version instead. See [`CLA-ENTITY.md`](CLA-ENTITY.md).

## How to sign

Open a pull request. A bot will comment on it with a link to this document and
ask you to reply with a single line confirming you agree. Your signature is
recorded against your GitHub account and covers all your future contributions;
you will only ever be asked once.

If you are contributing on behalf of an employer or any other organization, that
organization must sign [`CLA-ENTITY.md`](CLA-ENTITY.md) instead, by emailing a
signed copy to bluebubblesapp@gmail.com.

If you do not own the copyright in the entire work you are submitting (for
example, you are upstreaming a patch someone else wrote, or vendoring
third-party code), **do not sign in respect of that work.** Say so in the pull
request, identify the portions you did not author and their license, and we will
...
Copyright in the entire work of authorship, please follow the instructions under
**How to sign** above.
...
combination with the Material (and portions of such combination). This license is
granted only to the extent that the exercise of the licensed rights infringes
such patent claims; and provided that this license is conditioned upon compliance
with Section 2.3.
...
In addition, We may use the same licenses for Media in the Contribution
...
(d) You have followed the instructions under **How to sign** above, if You do not
...
PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO US. TO THE EXTENT
THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN
...
FOR ANY LOSS OF PROFITS, LOSS OF ANTICIPATED SAVINGS, LOSS OF DATA, INDIRECT,
SPECIAL, INCIDENTAL, CONSEQUENTIAL AND EXEMPLARY DAMAGES ARISING OUT OF THIS
AGREEMENT REGARDLESS OF THE LEGAL OR EQUITABLE THEORY (CONTRACT, TORT OR
OTHERWISE) UPON WHICH THE CLAIM IS BASED.

## 6. Miscellaneous

6.1 **Governing law and venue.** This Agreement will be governed by and construed
in accordance with the laws of the State of Maryland, United States of America,
...
Convention on Contracts for the International Sale of Goods ("UN Convention") and
the parties intend to avoid the application of the UN Convention to this
Agreement and, thus, exclude the application of the UN Convention in its entirety
to this Agreement.

Any action or proceeding arising out of or relating to this Agreement shall be
brought exclusively in the courts of the State of Maryland sitting in Anne
Arundel County, Maryland, or in the United States District Court for the District
of Maryland. Each party consents to the personal jurisdiction of those courts and
waives any objection to laying venue there, including any objection on the
grounds of forum non conveniens.

6.2 This Agreement sets out the entire agreement between You and Us for Your
Contributions to Us and overrides all other agreements or understandings.

6.3 If You or We assign the rights or obligations received through this Agreement
...
of the performance of the provision in the future or a waiver of the provision in
its entirety.
...
Adapted from the Harmony Individual Contributor License Agreement, version 1.0
(<https://www.harmonyagreements.org>), used under a Creative Commons Attribution
3.0 Unported License. Section 2.3 adopts Harmony's Option Five.
